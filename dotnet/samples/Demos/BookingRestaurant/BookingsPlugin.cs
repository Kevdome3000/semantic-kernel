...
internal sealed class BookingsPlugin
{
    ...
    public async Task<string> BookTableAsync(
        ...
        [Description("Number of people in your party")]
        int partySize,
    ...
    )
    {
        ...
        if (string.Equals(response, "yes", StringComparison.OrdinalIgnoreCase))
        {
            ...
            // list service IDs
            var services = await this._graphClient.Solutions.BookingBusinesses[this._businessId].
                Services.GetAsync();

            // To initialize your graphClient, see https://learn.microsoft.com/en-us/graph/sdks/create-client?from=snippets&tabs=csharp
            var result = await this._graphClient.Solutions.BookingBusinesses[this._businessId].
                Appointments.PostAsync(requestBody);
    ...
    public async Task<List<Appointment>> ListReservationsAsync()
    {
        ...
        var appointments = await this._graphClient.Solutions.BookingBusinesses[this._businessId].
            Appointments.GetAsync();
        ...
        int partySize)
    {
        ...
        await this._graphClient.Solutions.BookingBusinesses[this._businessId].
