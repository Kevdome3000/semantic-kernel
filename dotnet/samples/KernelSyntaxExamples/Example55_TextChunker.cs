...
public class Example55_TextChunker(ITestOutputHelper output) : BaseTest(output)
{
    ...
    public sealed class SharpTokenTokenCounter
    {
        ...
        public int Count(string input) => this._encoding.Encode(input).
            Count;
    ...
    public sealed class MicrosoftMLRobertaTokenCounter
    {
        ...
        public int Count(string input) => this._tokenizer.Encode(input).
            Tokens.Count;
    ...
    public class DeepDevTokenCounter
    {
        ...
        {
            this._tokenizer = TokenizerBuilder.CreateByEncoderNameAsync("cl100k_base").
                GetAwaiter().
                GetResult();
        }
