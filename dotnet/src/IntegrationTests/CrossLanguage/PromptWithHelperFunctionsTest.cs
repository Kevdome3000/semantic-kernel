...
public class PromptWithHelperFunctionsTest
{
    ...
    public async Task PromptWithHelperFunctionsAsync(
        bool isInline,
        bool isStreaming,
        ...
        string prompt)
    {
        ...
        await KernelRequestTracer.RunPromptAsync(kernel, isInline, isStreaming, templateFormat,
            prompt, new()
            {
                { "city", "Seattle" }
            });
    ...
    /// </summary>
    internal static DateTime UtcNow => new(1989, 6, 4, 12,
        11, 13);
