...
#pragma warning restore CS0618 // Events are deprecated
    ...
    public async Task ConnectorSpecificChatMessageContentClassesCanBeUsedForManualFunctionCallingAsync()
    {
        ...
        var toolCalls = ((OpenAIChatMessageContent)result).ToolCalls.OfType<ChatCompletionsFunctionToolCall>().
            ToList();
        ...
        while (toolCalls.Count > 0)
        {
            ...
            toolCalls = ((OpenAIChatMessageContent)result).ToolCalls.OfType<ChatCompletionsFunctionToolCall>().
                ToList();
        }
    ...
    public async Task ConnectorAgnosticFunctionCallingModelClassesCanBeUsedForManualFunctionCallingAsync()
    {
        ...
        var functionCalls = FunctionCallContent.GetFunctionCalls(messageContent).
            ToArray();
        ...
        while (functionCalls.Length != 0)
        {
            ...
            functionCalls = FunctionCallContent.GetFunctionCalls(messageContent).
                ToArray();
        }
    ...
    public async Task ConnectorAgnosticFunctionCallingModelClassesCanBeUsedForAutoFunctionCallingAsync()
    {
        ...
        var getCurrentTimeFunctionCallRequest = getCurrentTimeFunctionCallRequestMessage.Items.OfType<FunctionCallContent>().
            Single();
        ...
        var getCurrentTimeFunctionCallResult = getCurrentTimeFunctionCallResultMessage.Items.OfType<FunctionResultContent>().
            Single();
        ...
        var getWeatherForCityFunctionCallRequest = getWeatherForCityFunctionCallRequestMessage.Items.OfType<FunctionCallContent>().
            Single();
        ...
        var getWeatherForCityFunctionCallResult = getWeatherForCityFunctionCallResultMessage.Items.OfType<FunctionResultContent>().
            Single();
