...
#pragma warning restore CA1308 // Normalize strings to uppercase
    ...
    {
        var config = this._configuration.GetRequiredSection("AzureAISearch").
            Get<AzureAISearchConfiguration>();
        ...
        IndexDocumentsBatch<Hotel> batch = IndexDocumentsBatch.Create(
            ...
            IndexDocumentsAction.Upload(
                new Hotel()
                {
                    ...
                    ParkingIncluded = false,
                    LastRenovationDate = new DateTimeOffset(1979, 2, 18, 0,
                        0, 0, TimeSpan.Zero),
                    Rating = 3.60
                }),
            IndexDocumentsAction.Upload(
            ...
            IndexDocumentsAction.Upload(
                new Hotel()
                {
                    ...
                    ParkingIncluded = true,
                    LastRenovationDate = new DateTimeOffset(1960, 2, 06, 0,
                        0, 0, TimeSpan.Zero),
                    Rating = 4.60
                })
        );
