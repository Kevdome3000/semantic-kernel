...
public class AzureAISearchVectorStoreTests(ITestOutputHelper output, AzureAISearchVectorStoreFixture fixture)
{
    ...
    public async Task ItCanGetAListOfExistingCollectionNamesAsync()
    {
        ...
        // Act
        var collectionNames = await sut.ListCollectionNamesAsync().
            ToListAsync();

        // Assert
        Assert.Equal(2, collectionNames.Where(x => x.StartsWith(fixture.TestIndexName, StringComparison.InvariantCultureIgnoreCase)).
            Count());
