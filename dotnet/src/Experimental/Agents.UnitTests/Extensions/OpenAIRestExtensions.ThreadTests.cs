...
public sealed class OpenAIRestExtensionsThreadTests
{
    ...
    {
        await this._restContext.CreateThreadModelAsync().
            ConfigureAwait(true);
    ...
    {
        await this._restContext.GetThreadModelAsync(TestThreadId).
            ConfigureAwait(true);
    ...
    {
        await this._restContext.DeleteThreadModelAsync(TestThreadId).
            ConfigureAwait(true);
