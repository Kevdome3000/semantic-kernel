...
public sealed class OpenAIRestExtensionsRunTests
{
    ...
    {
        await this._restContext.CreateRunAsync(TestThreadId, TestAgentId).
            ConfigureAwait(true);
    ...
    {
        await this._restContext.GetRunAsync(TestThreadId, TestRunId).
            ConfigureAwait(true);
    ...
    {
        await this._restContext.GetRunStepsAsync(TestThreadId, TestRunId).
            ConfigureAwait(true);
    ...
    public async Task AddToolOutputsAsync()
    {
        ...
        await this._restContext.AddToolOutputsAsync(TestThreadId, TestRunId, toolResults).
            ConfigureAwait(true);
