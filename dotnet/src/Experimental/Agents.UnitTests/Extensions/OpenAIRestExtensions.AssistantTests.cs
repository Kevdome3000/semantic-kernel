...
public sealed class OpenAIRestExtensionsAssistantsTests
{
    ...
    {
        await this._restContext.CreateAssistantModelAsync(this._assistantModel).
            ConfigureAwait(true);
    ...
    {
        await this._restContext.GetAssistantModelAsync(TestAgentId).
            ConfigureAwait(true);
    ...
    {
        await this._restContext.ListAssistantModelsAsync(10, false, "20").
            ConfigureAwait(true);
    ...
    {
        await this._restContext.DeleteAssistantModelAsync(TestAgentId).
            ConfigureAwait(true);
