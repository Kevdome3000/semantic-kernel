...
public sealed class OpenAIRestExtensionsMessagesTests
{
    ...
    {
        await this._restContext.CreateUserTextMessageAsync(TestThreadId, TestContent, fileIds: null).
            ConfigureAwait(true);
    ...
    {
        await this._restContext.GetMessageAsync(TestThreadId, TestMessageId).
            ConfigureAwait(true);
    ...
    {
        await this._restContext.GetMessagesAsync(TestThreadId).
            ConfigureAwait(true);
    ...
    public async Task GetSpecificMessageModelsAsync()
    {
        ...
        await this._restContext.GetMessagesAsync(TestThreadId, messageIDs).
            ConfigureAwait(true);
