...
internal sealed class GeminiTokenCounterClient : ClientBase
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        using var httpRequestMessage = await this.CreateHttpRequestAsync(geminiRequest, this._tokenCountingEndpoint).
    ...
    private static int DeserializeAndProcessCountTokensResponse(string body)
    {
        ...
        return node["totalTokens"]?.
            GetValue<int>() ?? throw new KernelException("Invalid response from model");
    }
