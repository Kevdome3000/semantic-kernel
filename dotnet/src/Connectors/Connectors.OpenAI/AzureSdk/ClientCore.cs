...
internal abstract class ClientCore
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        for (int iteration = 1;; iteration++)
        {
            ...
            {
                return responseData.Choices.Select(chatChoice => new OpenAIChatMessageContent(chatChoice.Message, this.DeploymentOrModelName, GetChatChoiceMetadata(responseData, chatChoice))).
                    ToList();
            }
