...
#pragma warning restore CA1711 // Identifiers should not have incorrect
{
        ...
        AzureCosmosDBNoSQLVectorStoreRecordCollectionOptions<TRecord>? options = default)
    {
        ...
        this._partitionKeyPropertyName = !string.IsNullOrWhiteSpace(this._options.PartitionKeyPropertyName) ? this._options.PartitionKeyPropertyName! : this._keyProperty.DataModelPropertyName;
