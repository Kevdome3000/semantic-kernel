...
public class PineconeMemoryStoreTests
{
    ...
    {
        // Arrange
        this._mockPineconeClient.Setup<Task<bool>>(x => x.DoesIndexExistAsync(It.IsAny<string>(), It.IsAny<CancellationToken>())).
            ReturnsAsync(false);
        ...
        // Assert
        this._mockPineconeClient.Verify<Task<bool>>(x => x.DoesIndexExistAsync("test", It.IsAny<CancellationToken>()), Times.Once());
    ...
    public async Task ItWillNotOverwriteExistingIndexAsync()
    {
        ...
        this._mockPineconeClient.Setup<Task>(x => x.CreateIndexAsync(It.IsAny<IndexDefinition>(), It.IsAny<CancellationToken>()));
        ...
        // Assert
        this._mockPineconeClient.Verify<Task<bool>>(x => x.DoesIndexExistAsync("test", It.IsAny<CancellationToken>()), Times.Once());
        this._mockPineconeClient.Verify<Task>(x => x.CreateIndexAsync(IndexDefinition.Default("test"), It.IsAny<CancellationToken>()), Times.Never());
    }
    ...
    {
        // Arrange
        this._mockPineconeClient.Setup<IAsyncEnumerable<string?>>(x => x.ListIndexesAsync(It.IsAny<CancellationToken>())).
            Returns(new string[] { "test1", "test2" }.ToAsyncEnumerable());

        // Act
        var collections = await this._pineconeMemoryStore.GetCollectionsAsync().
            ToListAsync();
    ...
    {
        // Arrange
        this._mockPineconeClient.Setup<Task>(x => x.DeleteIndexAsync(It.IsAny<string>(), It.IsAny<CancellationToken>()));
        ...
        // Assert
        this._mockPineconeClient.Verify<Task>(x => x.DeleteIndexAsync("test", It.IsAny<CancellationToken>()), Times.Once());
    }
    ...
    public async Task UpsertAsyncInsertsNewDocumentAsync()
    {
        ...
        this._mockPineconeClient.Setup<IAsyncEnumerable<PineconeDocument?>>(x =>
                x.FetchVectorsAsync(It.IsAny<string>(), It.IsAny<IEnumerable<string>>(), It.IsAny<string>(), It.IsAny<bool>(),
                    It.IsAny<CancellationToken>())).
            Returns(AsyncEnumerable.Empty<PineconeDocument?>());

        this._mockPineconeClient.Setup<Task<int>>(x => x.UpsertAsync(It.IsAny<string>(), It.IsAny<IEnumerable<PineconeDocument>>(), It.IsAny<string>(), It.IsAny<CancellationToken>())).
            ReturnsAsync(1);
    ...
    public async Task UpsertBatchAsyncProcessesMultipleDocumentsAsync()
    {
        ...
        // Act
        List<string> upsertBatch = await this._pineconeMemoryStore.UpsertBatchAsync(indexName, records).
            ToListAsync();
    ...
    public async Task TestRemoveAsync()
    {
        ...
        this._mockPineconeClient.Setup<Task>(x => x.DeleteAsync(collectionName, new[] { key }, "", null,
        ...
        // Assert
        this._mockPineconeClient.Verify(x => x.DeleteAsync(collectionName, new[] { key }, "", null,
    ...
    public async Task TestGetNearestMatchesAsync()
    {
        ...
        this._mockPineconeClient.Setup<IAsyncEnumerable<(PineconeDocument, double)>>(x => x.GetMostRelevantAsync(
                It.IsAny<string>(),
