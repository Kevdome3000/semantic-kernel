...
public sealed class AzureAISearchMemoryStoreTests
{
    ...
    {
        this._mockSearchIndexClient.Setup(x => x.GetSearchClient(It.IsAny<string>())).
    ...
    public async Task GetCollectionsReturnsIndexNamesAsync()
    {
        ...
        this._mockSearchIndexClient.Setup(x => x.GetIndexesAsync(It.IsAny<CancellationToken>())).
            Returns(pageable);
    ...
    {
        // Arrange
        this._mockSearchIndexClient.Setup(x => x.DeleteIndexAsync(It.IsAny<string>(), It.IsAny<CancellationToken>())).
    ...
    public async Task UpsertReturnsValidRecordKeyAsync()
    {
        ...
        this._mockSearchClient.Setup(x => x.IndexDocumentsAsync<AzureAISearchMemoryRecord>(
    ...
    public async Task UpsertOnNotFoundErrorCreatesIndexAsync()
    {
        ...
        this._mockSearchClient.SetupSequence(x => x.IndexDocumentsAsync<AzureAISearchMemoryRecord>(
                It.IsAny<IndexDocumentsBatch<AzureAISearchMemoryRecord>>(),
                It.IsAny<IndexDocumentsOptions>(),
                It.IsAny<CancellationToken>())).
        ...
        this._mockSearchIndexClient.Setup(x => x.CreateIndexAsync(It.IsAny<SearchIndex>(), It.IsAny<CancellationToken>())).
        ...
        // Assert
        Assert.Equal("record-id", result);
        this._mockSearchIndexClient.Verify(x => x.CreateIndexAsync(It.IsAny<SearchIndex>(), It.IsAny<CancellationToken>()), Times.Once());
    }
    ...
    {
        // Arrange
        this._mockSearchClient.Setup(x => x.GetDocumentAsync<AzureAISearchMemoryRecord>(It.IsAny<string>(), It.IsAny<GetDocumentOptions>(), It.IsAny<CancellationToken>())).
    ...
    public async Task GetNearestMatchesReturnsValidRecordAsync()
    {
        ...
        var results = SearchModelFactory.SearchResults<AzureAISearchMemoryRecord>([searchResult], 1, null, 0.9,
            Mock.Of<Response>());

        this._mockSearchClient.Setup(x => x.SearchAsync<AzureAISearchMemoryRecord>(It.IsAny<string>(), It.IsAny<SearchOptions>(), It.IsAny<CancellationToken>())).
            ReturnsAsync(Response.FromValue(results, Mock.Of<Response>()));
    ...
    public async Task RemoveBatchCallsDeleteDocumentsMethodAsync()
    {
        ...
        this._mockSearchClient.Setup(x => x.DeleteDocumentsAsync<AzureAISearchMemoryRecord>(
        ...
        this._mockSearchClient.Verify(x => x.DeleteDocumentsAsync<AzureAISearchMemoryRecord>(
            It.IsAny<IEnumerable<AzureAISearchMemoryRecord>>(),
            It.IsAny<IndexDocumentsOptions>(),
