...
public class QdrantVectorStoreTests
{
    ...
    public void GetCollectionCallsFactoryIfProvided()
    {
        ...
        factoryMock.Setup(x => x.CreateVectorStoreRecordCollection<ulong, SinglePropsModel<ulong>>(It.IsAny<QdrantClient>(), TestCollectionName, null)).
    ...
    {
        // Arrange.
        this._qdrantClientMock.Setup(x => x.ListCollectionsAsync(It.IsAny<CancellationToken>())).
