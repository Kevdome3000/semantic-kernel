...
public sealed class GeminiRequestTests
{
    ...
    public void FromChatHistoryTextAsTextContentItReturnsGeminiRequestWithChatHistory()
    {
        ...
        Assert.Collection(request.Contents,
            c => Assert.Equal(chatHistory[0].Content, c.Parts![0].Text),
            c => Assert.Equal(chatHistory[1].Content, c.Parts![0].Text),
            c => Assert.Equal(chatHistory[2].Items!.Cast<TextContent>().
                Single().
                Text, c.Parts![0].Text));
    }
    ...
    public void FromChatHistoryImageAsImageContentItReturnsGeminiRequestWithChatHistory()
    {
        ...
        Assert.Collection(request.Contents,
            c => Assert.Equal(chatHistory[0].Content, c.Parts![0].Text),
            c => Assert.Equal(chatHistory[1].Content, c.Parts![0].Text),
            c => Assert.Equal(chatHistory[2].Items!.Cast<ImageContent>().
                    Single().
                    Uri,
    ...
    public void AddFunctionItAddsFunctionToGeminiRequest()
    {
        ...
        var function = new GeminiFunction("function-name", "function-description", "desc", null,
            null);
        ...
        // Assert
        Assert.Collection(request.Tools!.Single().
                Functions,
    ...
    public void AddMultipleFunctionsItAddsFunctionsToGeminiRequest()
    {
        ...
        var functions = new[]
        {
            new GeminiFunction("function-name", "function-description", "desc", null,
                null),
            new GeminiFunction("function-name2", "function-description2", "desc2", null,
                null)
        };
        ...
        Assert.Collection(request.Tools!.Single().
                Functions,
            func => Assert.Equivalent(functions[0].
                ToFunctionDeclaration(), func, strict: true),
            func => Assert.Equivalent(functions[1].
                ToFunctionDeclaration(), func, strict: true));
    }
