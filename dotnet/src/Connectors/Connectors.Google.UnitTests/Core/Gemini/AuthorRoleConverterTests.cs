...
public sealed class AuthorRoleConverterTests
{
    ...
    public void WriteWhenRoleIsUserReturnsUser()
    {
        ...
        // Assert
        Assert.Equal("\"user\""u8, bufferWriter.GetSpan().
            Trim((byte)'\0'));
    }
    ...
    public void WriteWhenRoleIsAssistantReturnsModel()
    {
        ...
        // Assert
        Assert.Equal("\"model\""u8, bufferWriter.GetSpan().
            Trim((byte)'\0'));
    }
    ...
    public void WriteWhenRoleIsToolReturnsFunction()
    {
        ...
        // Assert
        Assert.Equal("\"function\""u8, bufferWriter.GetSpan().
            Trim((byte)'\0'));
    }
    ...
    public void WriteWhenRoleIsNullReturnsNull()
    {
        ...
        // Assert
        Assert.Equal("null"u8, bufferWriter.GetSpan().
            Trim((byte)'\0'));
    }
