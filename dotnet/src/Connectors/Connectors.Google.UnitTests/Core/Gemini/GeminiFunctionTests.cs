...
public sealed class GeminiFunctionTests
{
    ...
    public void ItInitializesGeminiFunctionParameterCorrectly(
        string? name,
        string? description,
        string expectedName,
        string expectedDescription)
    {
        ...
        var functionParameter = new GeminiFunctionParameter(name, description, true, typeof(string),
            schema);
    ...
    public void ItCanConvertToFunctionDefinitionWithNoPluginName()
    {
        ...
        GeminiFunction sut = KernelFunctionFactory.CreateFromMethod(
                () => { }, "myfunc", "This is a description of the function.").
            Metadata.ToGeminiFunction();
    ...
    {
        // Arrange
        GeminiFunction sut = new("plugin", "function", "description", null,
            null);
    ...
    public void ItCanConvertToFunctionDefinitionsWithParameterTypesAndReturnParameterType()
    {
        ...
        GeminiFunction sut = plugin.GetFunctionsMetadata()[0].
            ToGeminiFunction();
