...
internal static class SqlServerCommandBuilder
{
        ...
        IEnumerable<TKey> keys)
    {
        ...
        sb.AppendKeyParameterList(keys,
            command,
            keyProperty,
            out bool emptyKeys);
        ...
        SqlVector<float> vector)
    {
        ...
        return UseVectorSearch(vectorProperty)
            ? SelectVectorWithVectorSearch(connection,
                schema,
                tableName,
                vectorProperty,
                model,
                ...
                distanceMetric,
                sorting)
            : SelectVectorWithVectorDistance(connection,
                schema,
                tableName,
                vectorProperty,
                model,
        ...
        string sorting)
    {
        ...
        if (options.Filter is not null)
        {
            ...
            SqlServerFilterTranslator translator = new(model,
                options.Filter,
                sb,
                startParamIndex);
        ...
        string sorting)
    {
        ...
        if (options.Filter is not null)
        {
            throw new NotSupportedException(
                "Filtering is not supported with approximate vector search (VECTOR_SEARCH). " + "Remove the filter or use IndexKind.Flat for exact search with VECTOR_DISTANCE.");
        }
        ...
        string keywords)
    {
        ...
        sb.Append("        COALESCE(ss.")
            .AppendIdentifier(model.KeyProperty.StorageName)
            .Append(", ks.")
            .AppendIdentifier(model.KeyProperty.StorageName)
            .AppendLine(") AS combined_key,");
        ...
        sb.Append("    FULL OUTER JOIN keyword_search ks ON ss.")
            .AppendIdentifier(model.KeyProperty.StorageName)
            .Append(" = ks.")
            .AppendIdentifier(model.KeyProperty.StorageName)
            .AppendLine();
    ...
    {
        return vectorProperty.IndexKind is not (null or "" or IndexKind.Flat);
    }
}
