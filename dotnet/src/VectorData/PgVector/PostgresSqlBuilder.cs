...
internal static class PostgresSqlBuilder
{
    ...
    internal static string BuildCreateTableSql(
       ...
       Version pgVersion, bool ifNotExists = true)
    {
    ...
    internal static string BuildCreateIndexSql(
        ...
        bool isVector,
        bool isFullText, string? fullTextLanguage, bool ifNotExists)
    {
        ...
        Dictionary<VectorPropertyModel, IReadOnlyList<Embedding>>? generatedEmbeddings)
    {
        ...
        foreach (var record in records)
        {
            ...
            foreach (var property in model.Properties)
            {
                ...
                batchCommand.Parameters.Add(new NpgsqlParameter { Value = value ?? DBNull.Value });
            }
    ...
    /// </summary>
    internal static StringBuilder AppendIdentifier(this StringBuilder sb,
        string identifier)
