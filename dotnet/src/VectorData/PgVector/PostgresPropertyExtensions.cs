...
public static class PostgresPropertyExtensions
{
    ...
    {
        return property.ProviderAnnotations?.TryGetValue(FullTextSearchLanguageKey, out var value) == true
            ? value as string
            : null;
    }
    ...
    {
        return property.ProviderAnnotations?.TryGetValue(FullTextSearchLanguageKey, out var value) == true && value is string language
            ? language
    ...
    {
        return property.ProviderAnnotations?.TryGetValue(StoreTypeKey, out var value) == true
            ? value as string
            : null;
    }
