...
public sealed class CosmosNoSqlCollectionOptions : VectorStoreCollectionOptions
{
    ...
    internal CosmosNoSqlCollectionOptions(CosmosNoSqlCollectionOptions? source) : base(source)
    {
        ...
        PartitionKeyProperties = source?.PartitionKeyProperties is null
            ? null
            : [.. source.PartitionKeyProperties];
        IndexingMode = source?.IndexingMode ?? Default.IndexingMode;
        Automatic = source?.Automatic ?? Default.Automatic;
    }
