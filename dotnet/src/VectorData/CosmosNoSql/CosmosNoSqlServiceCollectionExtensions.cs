...
public static class CosmosNoSqlServiceCollectionExtensions
{
    ...
    {
        return AddKeyedCosmosNoSqlVectorStore(services,
            null,
            options,
            lifetime);
    }
        ...
        ServiceLifetime lifetime = ServiceLifetime.Singleton)
    {
        ...
        services.Add(new ServiceDescriptor(typeof(CosmosNoSqlVectorStore),
            serviceKey,
            (sp, _) =>
            {
        ...
        services.Add(new ServiceDescriptor(typeof(VectorStore),
            serviceKey,
            static (sp, key) => sp.GetRequiredKeyedService<CosmosNoSqlVectorStore>(key),
            lifetime));
        ...
        ServiceLifetime lifetime = ServiceLifetime.Singleton)
    {
        ...
        services.Add(new ServiceDescriptor(typeof(CosmosNoSqlVectorStore),
            ...
            (sp, _) =>
            {
                ...
                return new CosmosNoSqlVectorStore(connectionString,
                    databaseName,
                    clientOptions,
                    options);
            },
    ...
    public static IServiceCollection AddCosmosNoSqlCollection<TKey, TRecord>(
        ...
        where TRecord : class
    {
        return AddKeyedCosmosNoSqlCollection<TKey, TRecord>(services,
            null,
            name,
            options,
            lifetime);
        ...
        where TRecord : class
    {
        ...
        services.Add(new ServiceDescriptor(typeof(CosmosNoSqlCollection<TKey, TRecord>),
            serviceKey,
            (sp, _) =>
            {
                var database = sp.GetRequiredService<Database>();
        ...
        where TRecord : class
    {
        services.Add(new ServiceDescriptor(typeof(VectorStoreCollection<TKey, TRecord>),
            serviceKey,
            static (sp, key) => sp.GetRequiredKeyedService<CosmosNoSqlCollection<TKey, TRecord>>(key),
            lifetime));
    ...
    private static CosmosClientOptions CreateClientOptions(JsonSerializerOptions? jsonSerializerOptions)
    {
        return new()
        {
