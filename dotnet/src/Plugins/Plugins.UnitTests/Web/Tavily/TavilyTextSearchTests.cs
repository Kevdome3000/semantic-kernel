...
public sealed class TavilyTextSearchTests : IDisposable
{
    ...
    public void AddTavilyTextSearchSucceeds()
    {
        ...
        // Act
        builder.AddTavilyTextSearch("ApiKey");
    ...
    public async Task SearchReturnsSuccessfullyAsync()
    {
        ...
        var textSearch = new TavilyTextSearch("ApiKey", new TavilyTextSearchOptions { HttpClient = _httpClient });
    ...
    public async Task GetSearchResultsReturnsSuccessfullyAsync()
    {
        ...
        // Create an ITextSearch instance using Tavily search
        var textSearch = new TavilyTextSearch("ApiKey", new TavilyTextSearchOptions { HttpClient = _httpClient, IncludeRawContent = true });

        // Act
        KernelSearchResults<object> result = await textSearch.GetSearchResultsAsync("What is the Semantic Kernel?", new TextSearchOptions { Top = 4, Skip = 0 });
    ...
    public async Task SearchWithCustomStringMapperReturnsSuccessfullyAsync()
    {
        ...
        // Create an ITextSearch instance using Tavily search
        var textSearch = new TavilyTextSearch("ApiKey", new TavilyTextSearchOptions { HttpClient = _httpClient, StringMapper = new TestTextSearchStringMapper() });
    ...
    public async Task GetTextSearchResultsWithCustomResultMapperReturnsSuccessfullyAsync()
    {
        ...
        // Create an ITextSearch instance using Tavily search
        var textSearch = new TavilyTextSearch("ApiKey", new TavilyTextSearchOptions { HttpClient = _httpClient, ResultMapper = new TestTextSearchResultMapper() });
    ...
    public async Task SearchWithAnswerReturnsSuccessfullyAsync()
    {
        ...
        // Create an ITextSearch instance using Tavily search
        var textSearch = new TavilyTextSearch("ApiKey", new TavilyTextSearchOptions { HttpClient = _httpClient, IncludeAnswer = true });
    ...
    public async Task SearchWithImagesReturnsSuccessfullyAsync()
    {
        ...
        // Create an ITextSearch instance using Tavily search
        var textSearch = new TavilyTextSearch("ApiKey", new TavilyTextSearchOptions { HttpClient = _httpClient, IncludeImages = true });
    ...
    public async Task GetTextSearchResultsWithImagesReturnsSuccessfullyAsync()
    {
        ...
        // Create an ITextSearch instance using Tavily search
        var textSearch = new TavilyTextSearch("ApiKey", new TavilyTextSearchOptions { HttpClient = _httpClient, IncludeImages = true, IncludeImageDescriptions = true });
    ...
    public async Task BuildsCorrectRequestForEqualityFilterAsync(string paramName, object paramValue, string request)
    {
        ...
        // Assert
        var requestContents = _messageHandlerStub.RequestContents;
    ...
    public async Task LinqSearchAsyncReturnsResultsSuccessfullyAsync()
    {
        // Arrange
        _messageHandlerStub.AddJsonResponse(File.ReadAllText(SiteFilterDevBlogsResponseJson));
        ITextSearch<TavilyWebPage> textSearch = new TavilyTextSearch("ApiKey", new TavilyTextSearchOptions { HttpClient = _httpClient });
