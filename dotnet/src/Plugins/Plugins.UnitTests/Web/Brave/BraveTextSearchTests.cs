...
public sealed class BraveTextSearchTests : IDisposable
{
    ...
    public void AddBraveTextSearchSucceeds()
    {
        ...
        // Act
        builder.AddBraveTextSearch("ApiKey");
    ...
    public async Task SearchReturnsSuccessfullyAsync()
    {
        ...
        var textSearch = new BraveTextSearch("ApiKey", new BraveTextSearchOptions { HttpClient = _httpClient });
    ...
    public async Task SearchWithCustomStringMapperReturnsSuccessfullyAsync()
    {
        ...
        // Create an ITextSearch instance using Brave search
        var textSearch = new BraveTextSearch("ApiKey", new BraveTextSearchOptions { HttpClient = _httpClient, StringMapper = new TestTextSearchStringMapper() });
    ...
    public async Task GetTextSearchResultsWithCustomResultMapperReturnsSuccessfullyAsync()
    {
        ...
        // Create an ITextSearch instance using Brave search
        var textSearch = new BraveTextSearch("ApiKey", new BraveTextSearchOptions { HttpClient = _httpClient, ResultMapper = new TestTextSearchResultMapper() });
    ...
    {
        // Arrange
        _messageHandlerStub.AddJsonResponse(File.ReadAllText(SiteFilterSkResponseJson));
    ...
    public async Task LinqSearchAsyncReturnsResultsSuccessfullyAsync()
    {
        // Arrange
        _messageHandlerStub.AddJsonResponse(File.ReadAllText(WhatIsTheSkResponseJson));
        ITextSearch<BraveWebPage> textSearch = new BraveTextSearch("ApiKey", new BraveTextSearchOptions { HttpClient = _httpClient });
