...
public partial class SessionsPythonPlugin
{
    ...
    public async Task<SessionsRemoteFileMetadata> UploadFileAsync(
        [Description("The path to the file in the session.")]
    ...
    public async Task<byte[]> DownloadFileAsync(
        [Description("The path to download the file from, relative to `/mnt/data`.")]
        string remoteFilePath,
        [Description("The path to save the downloaded file to. If not provided won't save it in the disk.")]
