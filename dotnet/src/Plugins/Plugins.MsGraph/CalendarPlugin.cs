...
public sealed class CalendarPlugin
{
    ...
    public CalendarPlugin(ICalendarConnector connector, ILoggerFactory? loggerFactory = null, JsonSerializerOptions? jsonSerializerOptions = null)
    {
        ...
        _logger = loggerFactory?.CreateLogger(typeof(CalendarPlugin)) ?? NullLogger.Instance;
    }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        IEnumerable<CalendarEvent>? events = await _connector.GetEventsAsync(
                top: maxResults,
                skip: skip,
                select: SelectString,
                cancellationToken
        ...
        return JsonSerializer.Serialize(value: events, options: _jsonSerializerOptions);
    }
}
