...
internal sealed class EmptyKeyedServiceProvider : IKeyedServiceProvider
{
    ...
    {
        return GetKeyedService(serviceType, serviceKey) ?? throw new InvalidOperationException($"No service for type '{serviceType}' and key '{serviceKey}' has been registered.");
    }
}
