...
namespace System.Reflection
{
    ...
    internal sealed class NullabilityInfoContext
    {
        ...
        public NullabilityInfo Create(FieldInfo fieldInfo)
        {
            ...
            NullableAttributeStateParser parser = IsPrivateOrInternalFieldAndAnnotationDisabled(fieldInfo)
                ? NullableAttributeStateParser.Unknown
                : CreateParser(attributes);
            ...
            ref int index)
        {
            ...
            return new NullabilityInfo(type, state, state, elementState,
            ...
            Type reflectedType)
        {
            ...
            Type contextTypeDefinition = context.IsGenericType && !context.IsGenericTypeDefinition
            ...
            if (!baseType.IsGenericType
                || (baseType.IsGenericTypeDefinition
                    ? baseType
                    : baseType.GetGenericTypeDefinition()) != genericParameter.DeclaringType)
            {
            ...
            static int CountNullabilityStates(Type type)
            {
                ...
                if (underlyingType.HasElementType)
                {
                    return (underlyingType.IsArray
                        ? 1
                        : 0) + CountNullabilityStates(underlyingType.GetElementType()!);
                }
