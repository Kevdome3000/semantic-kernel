...
public class KernelPluginTests
{
    ...
    public void ItRoundTripsCtorArguments()
    {
        ...
        Assert.Equal("Function1", functions[0].
            ToString());

        Assert.Equal("Function2", functions[1].
            ToString());

        Assert.Equal("Function3", functions[2].
            ToString());
        ...
        Assert.Equal("name.Function1", plugin["Function1"].
            ToString());

        Assert.Equal("name.Function2", plugin["Function2"].
            ToString());

        Assert.Equal("name.Function3", plugin["Function3"].
            ToString());
    ...
    public async Task ItContainsAddedFunctionsAsync()
    {
        ...
        var result2 = await plugin[func1.Name].
            InvokeAsync(kernel);
        ...
        var result4 = await plugin[func2.Name].
            InvokeAsync(kernel);
    ...
    {
        Assert.Empty(KernelPluginFactory.CreateFromFunctions("plugin1").
