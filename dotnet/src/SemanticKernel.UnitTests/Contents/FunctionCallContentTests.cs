...
public class FunctionCallContentTests
{
    ...
    public void ItShouldReturnListOfFunctionCallRequests()
    {
        ...
        // Act
        var result = FunctionCallContent.GetFunctionCalls(chatMessage).
            ToArray();
        ...
        Assert.Equal("id1", result.ElementAt(0).
            Id);

        Assert.Equal("id2", result.ElementAt(1).
            Id);

        Assert.Equal("id3", result.ElementAt(2).
            Id);
    }
