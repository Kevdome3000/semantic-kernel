...
public class RestApiOperationTests
{
    ...
    public void ItShouldUseHostUrlOverrideIfProvided()
    {
        ...
        // Act
        var url = sut.BuildOperationUrl(arguments, new Uri(fakeHostUrlOverride));
    ...
    public void ItShouldUseParameterArgumentNameToLookupArgumentsToBuildOperationUrl()
    {
        ...
        var parameters = new List<RestApiParameter>
        {
            new(
                ...
                false,
                RestApiParameterLocation.Path,
                RestApiParameterStyle.Simple) { ArgumentName = "alt-p1" },
            new(
                "p2",
                "number",
                true,
                false,
                RestApiParameterLocation.Path,
                RestApiParameterStyle.Simple) { ArgumentName = "alt-p2" }
        };
    ...
    public void ItShouldBuildQueryString()
    {
        ...
        // Assert
        Assert.Equal("since_create_time=2024-01-01T00%3A00%3A00%2B00%3A00&before_create_time=2024-05-01T00%3A00%3A00%2B00%3A00", queryString, true);
    }
    ...
    public void ItShouldUseParameterArgumentNameToLookupArgumentsToBuildQueryString()
    {
        ...
        var parameters = new List<RestApiParameter>
        {
            new(
                ...
                false,
                false,
                RestApiParameterLocation.Query) { ArgumentName = "alt_p1" },
            new(
                "p2",
                "string",
                false,
                false,
                RestApiParameterLocation.Query) { ArgumentName = "alt_p2" }
        };
        ...
        // Assert
        Assert.Equal("p1=v1&p2=v2", queryString, true);
    }
    ...
    public void ItShouldBuildQueryStringWithQuotes()
    {
        ...
        // Assert
        Assert.Equal("has_quotes=%22Quoted+Value%22", queryString, true);
    }
    ...
    public void ItShouldBuildQueryStringForArray()
    {
        ...
        var arguments = new Dictionary<string, object?>
        {
            { "times", new[] { "2024-01-01T00:00:00+00:00", "2024-05-01T00:00:00+00:00" } }
        };
        ...
        // Assert
        Assert.Equal("times=2024-01-01T00%3A00%3A00%2B00%3A00,2024-05-01T00%3A00%3A00%2B00%3A00", queryString, true);
    }
    ...
    public void ItShouldRenderHeaderValuesFromArguments()
    {
        ...
        var sut = new RestApiOperation(
            "fake_id",
            [new RestApiServer("http://fake_url")],
            "fake_path",
            HttpMethod.Get,
            "fake_description",
            parameters,
    ...
    public void ItShouldUseParameterArgumentNameToLookupArgumentsToCreateOperationHeaders()
    {
        ...
        var parameters = new List<RestApiParameter>
        {
            new(
                ...
                false,
                RestApiParameterLocation.Header,
                RestApiParameterStyle.Simple) { ArgumentName = "alt_h1" },
            ...
            new(
                ...
                false,
                RestApiParameterLocation.Header,
                RestApiParameterStyle.Simple) { ArgumentName = "alt_h2" }
        };
    ...
    public void ShouldThrowExceptionIfNoValueProvidedForRequiredHeader()
    {
        ...
        void Act()
        {
            sut.BuildHeaders(new Dictionary<string, object?>());
        }
...
#pragma warning restore CS8769
    ...
    public void ItBuildsServicesIntoKernel()
    {
        var builder = Kernel.CreateBuilder()
            .AddOpenAIChatCompletion("abcd", "efg", serviceId: "openai")
            .AddAzureOpenAIChatCompletion("hijk",
                modelId: "qrs",
                endpoint: "https://lmnop",
                apiKey: "tuv",
    ...
    public void ItIsntNeededInDIContexts()
    {
        ...
        serviceCollection.AddAzureOpenAIChatCompletion("abcd",
            modelId: "efg",
            endpoint: "https://hijk",
            apiKey: "lmnop");
        serviceCollection.AddAzureOpenAIChatCompletion("abcd",
        ...
        serviceCollection.AddKeyedSingleton("KernelServiceTypeToKeyMappings", mapping);
        //**
    ...
    public void ItFindsPluginCollectionToUse()
    {
        ...
        IKernelBuilder builder = Kernel.CreateBuilder();
        builder.Services.AddTransient<KernelPluginCollection>(_ => new KernelPluginCollection([plugin1, plugin2, plugin3]));
    ...
    public void ItShouldAllowModifyProperties()
    {
        ...
        var sut = new RestApiOperation(
            ...
            payload: new RestApiPayload(
                "application/json",
                new List<RestApiPayloadProperty>
                {
                    new(
                        "p3",
                        "string",
        ...
        sut.Payload!.Properties.Single(p => p.Name == "p3")
        .Properties.Add(new RestApiPayloadProperty("p4",
            "string",
            false,
            []));
    ...
    public void ItShouldFreezeModifiableProperties()
    {
        ...
        Assert.Throws<NotSupportedException>(() => sut.Payload!.Properties.Single(p => p.Name == "p3")
        .Properties.Add(new RestApiPayloadProperty("p4",
            "string",
            false,
            [])));
