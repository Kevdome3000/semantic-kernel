...
public class OpenAIFunctionExecutionParameters : OpenApiFunctionExecutionParameters
{
    ...
    public OpenAIFunctionExecutionParameters(
        ...
        bool enablePayloadNamespacing = false) : base(httpClient, null, serverUrlOverride, userAgent,
        ignoreNonCompliantErrors, enableDynamicOperationPayload, enablePayloadNamespacing)
    {
